                    ...
                    <div class="row y-middle">
                            ...
                            <div class="services-item silver">
                                <div class="services-wrap">
                                    <div class="services-icon">
                                        <img src="new/assets/images/medals/silver.png" alt="Services">
                                    </div>
                        ...
                        <div class="col-lg-4 col-md-6 md-mb-30">
                            <div class="services-item gold">
                                <div class="services-wrap">
                                    <div class="services-icon">
                                        <img src="new/assets/images/medals/gold.png" alt="Services">
                                    </div>
                                    <div class="services-text">
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="services-item bronze">
                                <div class="services-wrap">
                                    <div class="services-icon">
                                        <img src="new/assets/images/medals/bronze.png" alt="Services">
                                    </div>
                                    <div class="services-text">
