...
<html lang="zxx"> 
    ...
    <body class="defult-home">
        ...
        <div id="rs-our-sponsor" class="rs-our-sponsor style1 home4-sponsor-style bg18">
            <div class="logo-area">
                <a href="/">              
            ...
            <div class="container">
                ...
                <div class="row justify-content-center align-items-center" style="height:100vh">
                    <div class="col-lg-6 col-md-6 col-12 mb-20">
                        ...
                        <div class="logo-item sec-title text-center">
                            ...
                            <div class="grid-figure">
                                ...
                                <div class="logo-img text-center">
                                    <a href="#"><img src="{{asset('new/assets/images/tick.png')}}" alt="logo-img"></a>
                                </div>
                                <p class="desc-big">Thank you for your video submission! Stay tuned for the winner's announcement.</p>
                            </div>
                        </div>
                    </div>
                </div>
