    ...
    <body class="defult-home">
        ...
        <div id="pre-load">
           <div id="loader" class="loader">
               <div class="loader-container">
                   <div class='loader-icon'><img src="assets/images/ajanta-logo.png" alt="agtian"></div>
               </div>
           </div>              
       </div>
        ...
        <div class="main-content">
            ...
            <div class="rs-about style2 bg17" id="about">
                <div class="container">
                    <div class="left-side">
                        <img class="wow fadeInLeft" src="assets/images/1.png" alt="Images">
                    </div>
                    <div class="right-side">
                        <img class="wow fadeInRight" src="assets/images/2.png" alt="Images">
                    </div>
            ...
            <div class="rs-team style8">
                ...
                <div class="team-line">
                    <div class="line-animate left-side">
                        <img class="wow fadeInLeft" src="assets/images/line/1.png" alt="Images">
                    </div>
                    <div class="line-animate right-side">
                        <img class="wow fadeInRight" src="assets/images/line/2.png" alt="Images">
                    </div>
                </div>
            </div> 
